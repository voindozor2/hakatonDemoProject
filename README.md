...
##### Примечание: несмотря на то, что стандарт SQL допускает фантомные чтения при уровне изоляции `REPEATABLE READ`, в PostgreSQL изменения, внесенные конкурентными транзакциями невидимы для процессов внутри транзакции.
